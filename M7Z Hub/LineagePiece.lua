...
local function processSeed(seed)
 ...
 if prompt and State.Active then
  ...
  if State.Active and seed.Parent and seed:IsDescendantOf(Workspace) then
   StatusLabel.Text = "Coletando Semente..."
   while State.Active and seed.Parent and seed:IsDescendantOf(Workspace) do
    task.wait(0.1)
