local Get = loadstring(game:HttpGet("https://raw.githubusercontent.com/SomeoneScripts/Repo/refs/heads/main/Translations/Translation.lua"))().Get
...
local WTitle = Get(Configs[1] or Configs.Name or Configs.Title or "redz Library V5")
local WMiniText = Get(Configs[2] or Configs.SubTitle or "by : redz9999")
...
local DTitle = Get(Configs[1] or Configs.Title or "Dialog")
local DText = Get(Configs[2] or Configs.Text or "This is a Dialog")
...
local Name = Get(Configs[1] or Configs.Name or Configs.Title or "")
...
local TName = Get(Configs[1] or Configs.Title or "Tab!")
...
local SectionName = Get(type(Configs) == "string" and Configs or Configs[1] or Configs.Name or Configs.Title or Configs.Section)
...
local PName = Get(Configs[1] or Configs.Title or "Paragraph")
local PDesc = Get(Configs[2] or Configs.Text or "")
...
local BName = Get(Configs[1] or Configs.Name or Configs.Title or "Button!")
local BDescription = Get(Configs.Desc or Configs.Description or "")
...
local TName = Get(Configs[1] or Configs.Name or Configs.Title or "Toggle")
local TDesc = Get(Configs.Desc or Configs.Description or "")
...
local DName = Get(Configs[1] or Configs.Name or Configs.Title or "Dropdown")
local DDesc = Get(Configs.Desc or Configs.Description or "")
...
local SName = Get(Configs[1] or Configs.Name or Configs.Title or "Slider!")
local SDesc = Get(Configs.Desc or Configs.Description or "")
...
local TName = Get(Configs[1] or Configs.Name or Configs.Title or "Text Box")
local TDesc = Get(Configs.Desc or Configs.Description or "")
local TDefault = Configs[2] or Configs.Default or ""
local TPlaceholderText = Get(Configs[5] or Configs.PlaceholderText or "Input")
...
local InviteCode = Configs.Invite or Configs[3] or ""
if string.find(InviteCode, "discord.gg/") then
InviteCode = string.match(InviteCode, "discord.gg/(.+)")
elseif string.find(InviteCode, "discord.com/invite/") then
InviteCode = string.match(InviteCode, "discord.com/invite/(.+)")
end
...
local Card = InsertTheme(Create("Frame", InviteHolder, {
...
local Banner = Create("ImageLabel", Card, {
...
Make("Corner", Banner, UDim.new(0, 8))

local IconFrame = Create("Frame", Card, {
Size = UDim2.new(0, 64, 0, 64),
Position = UDim2.new(0, 12, 0, 28),
BackgroundColor3 = Color3.fromRGB(43, 45, 49),
BackgroundTransparency = 0
})
Make("Corner", IconFrame, UDim.new(0, 12))

local IconImage = Create("ImageLabel", IconFrame, {
...
local LTitle = Create("TextLabel", Card, {
...
local LDesc = Create("TextLabel", Card, {
Size = UDim2.new(1, -24, 0, 20),
Position = UDim2.new(0, 12, 0, 95),
Font = Enum.Font.Gotham,
Text = "",
TextColor3 = Color3.fromRGB(181, 186, 193),
TextSize = 13,
BackgroundTransparency = 1,
TextXAlignment = "Left"
})

local LMembers = Create("TextLabel", Card, {
Size = UDim2.new(1, -24, 0, 20),
...
local JoinButton = Create("TextButton", Card, {
...
TextSize = 14,
TextColor3 = Color3.new(1, 1, 1),
BackgroundColor3 = Color3.fromRGB(35, 165, 89)
})
Make("Corner", JoinButton, UDim.new(0, 4))

task.spawn(function()
local url = "https://discord.com/api/invite/" .. InviteCode .. "?with_counts=true"
local response = game:HttpGet(url)
local data = game:GetService("HttpService"):JSONDecode(response)

if data and data.guild then
LTitle.Text = data.guild.name
LDesc.Text = data.guild.description or ""
LMembers.Text = "🟢 " .. data.approximate_presence_count .. " Online  ⚪ " .. data.approximate_member_count .. " Members"

local iconUrl = "https://cdn.discordapp.com/icons/" .. data.guild.id .. "/" .. data.guild.icon .. ".png"
local fileName = "DIcon_" .. data.guild.id .. ".png"
writefile(fileName, game:HttpGet(iconUrl))
IconImage.Image = getcustomasset(fileName)

if data.guild.banner then
local bannerUrl = "https://cdn.discordapp.com/banners/" .. data.guild.id .. "/" .. data.guild.banner .. ".png"
local bFileName = "DBanner_" .. data.guild.id .. ".png"
writefile(bFileName, game:HttpGet(bannerUrl))
Banner.Image = getcustomasset(bFileName)
end
else
LTitle.Text = "Invalid Invite"
end
end)
...
JoinButton.BackgroundColor3 = Color3.fromRGB(35, 165, 89)
end)
